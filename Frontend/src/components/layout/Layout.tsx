        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white dark:bg-gray-800">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900 dark:text-white">Quran Quest</span>
            </div>
            <button
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:hidden">
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold text-gray-900 dark:text-white">Quran Quest</span>
            </div>
          </div>
        </div>
